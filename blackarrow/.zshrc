...
###########
	...
	# GZG #
		...
		alias  gzgbuild='cd ~/grandzonegaming && JEKYLL_ENV=production NODE_ENV=production bundle exec jekyll build'
		alias      gzgb='cd ~/grandzonegaming && JEKYLL_ENV=production NODE_ENV=production bundle exec jekyll build'
